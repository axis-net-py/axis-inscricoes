...
export async function getCRMExportByEvents(filters={}) {
  ...
  return sql`SELECT r.id,r.status,r.created_at,r.accessibility_required,r.accessibility_details,r.dietary_restriction,r.dietary_restriction_other,
    c.first_name,c.last_name,c.phone,c.company,c.email,e.name event_name,e.slug,
