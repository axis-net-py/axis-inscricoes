...
export default async function CRM({searchParams}){
  ...
  return <div className="admin-shell">
    ...
    <main className="admin-wrap admin-main">
      <section className="admin-crm-head"><div><span className="admin-kicker">BASE DE RELACIONAMENTO</span><h1>Inscritos <em>e contatos</em></h1><p>Consulte participantes de todos os eventos, refine a base e acesse pagamentos e comprovantes sem perder o contexto histórico.</p></div><div className="admin-crm-total"><strong>{d.total}</strong><span>resultados</span></div></section>
